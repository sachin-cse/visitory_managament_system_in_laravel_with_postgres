    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="javascript:void(0);" data-url="{{route('admin.teacher.handle_teacher_action_type', 'add')}}" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded action_type">
