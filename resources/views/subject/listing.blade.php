                            ...
                            @foreach($subject_data as $value)
                                <tr class="text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                                    ...
                                    @if($value->teachers->count() > 0)
                                        ...
                                        <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{$teacher->name}}</td>
                                        @endforeach
                                    @endif
                                    <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{$value->subject_status}}</td>
