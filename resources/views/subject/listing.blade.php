    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{route('admin.handle_subject_request', 'add')}}" data-url="{{route('admin.handle_subject_request', 'add')}}" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded action_type">
            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                        <tr class="text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                            <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"></td>
                            <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"></td>
                            <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"></td>
                            <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"></td>
                            <td class="px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight"></td>
                            <td class="flex items-center justify-end px-3 py-4">
                                ...
                                <a href="javascript:void(0);" data-url="" class="deletebtn ml-1 bg-red-600 block p-1 border border-red-600 rounded-sm delete-user" title="Delete User">
                                ...
                                <!-- Active status -->
                                <a href="javascript:void(0);" data-value="2" data-url="" class="ml-1 bg-green-600 block p-1 border border-none-600 rounded-sm change-status" title="Change User Status">
                                ...
                                {{-- <a href="javascript:void(0);" data-value="" data-url="" class="ml-1 bg-grey-600 block p-1 border border-none-600 rounded-sm show_user_model" title="Set User Role">
